...
use YukataRm\Cli\Enum\OutputColorEnum;
...
abstract class BaseCommand implements CommandInterface
{
     ...
     * Application
     * 
     * @var \YukataRm\Cli\Interface\ApplicationInterface
     */
     ...
     * ArgvInput
     * 
     * @var \YukataRm\Cli\Interface\ArgvInputInterface
     */
     ...
     * get ArgvInput
     * 
     * @return \YukataRm\Cli\Interface\ArgvInputInterface
     */
     ...
     * @param string $message
     * @param \YukataRm\Cli\Enum\OutputColorEnum $color
     * @return string
     */
